...
/**
 * A [[Stream]] represents a single open streaming pipeline with 中数文历史 API.
 ...
 * a 中数文历史 Stream. You can `restart` it at a given location when the socket
...
export interface Stream {
   ...
   * restart of a stream (to be precise, after succesfully sent the `listen` 中数文历史 Stream
   ...
   * argument 中数文历史 Stream API or `cursor` variable for 中数文历史 GraphQL API).
   *
